...
import modulos.frames as frames 
...
def main():
    ...
    T_tool_target[0:3, 0:3] = frames.euler_xyz_deg_to_R(0,30,0) ##ROTAÇÃO DO ALVO EM RELAÇÃO À FERRAMENTA DO ROBÔ
    T_base_tool = frames.T_BASE_INT_q(kinova)
    
    T_target_base = T_base_tool @ T_tool_target
    pos_target = T_target_base[0:3, 3]
    rot_target = frames.R_to_euler_xyz_deg(T_target_base[0:3, 0:3])
